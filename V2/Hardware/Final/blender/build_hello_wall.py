...
MECHANICAL_OUTPUT = BLENDER_DIR.parent / "mechanical/generated/captured-enclosure"
MM = 0.001
ROWS = ("HALLO", "WELT!")
...
def configure_scene() -> None:
    ...
    scene["source_capture"] = str(CAPTURE_PATH.relative_to(REPOSITORY_ROOT))
...
def main() -> int:
    ...
    apply_blend_license_metadata(bpy.context.scene)
