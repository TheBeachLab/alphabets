...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default="definitive",
        help="physical V2 variant; this directory generates Definitivo only",
    )
    parser.add_argument(
        "--profile",
        type=Path,
    ...
    if variant.id != "definitive":
        parser.error(
            f"{variant.name} is generated by V2/Hardware/Prototype/mechanical; "
            "run its generator from that directory"
        )
