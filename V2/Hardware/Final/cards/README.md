...
/Applications/FreeCAD.app/Contents/Resources/bin/FreeCADCmd \
  V2/Hardware/Final/cards/generate_card.py
```
...
`../../Prototype/structure/spool.scad` is the preserved OpenSCAD reference and
derives the drum separation from `flap_width = 50`
...
```sh
openscad -o V2/Hardware/Prototype/structure/spool-50mm.dxf \
...
The generated `../../Prototype/structure/spool-50mm.dxf` contains the 85 mm side disc and
