...
class CardGeometryTests(unittest.TestCase):
    ...
    def test_card_matches_the_45x91_sticker_halves(self):
        sticker = json.loads(
            (
                REPO_ROOT
                / "V2/Hardware/Final/stickers/generated/international-64-black-white-45x91.json"
    ...
    def test_spool_source_uses_matching_width_and_preserves_64_positions(self):
        source = (REPO_ROOT / "V2/Hardware/Prototype/structure/spool.scad").read_text(
            encoding="utf-8"
        )
        ...
        dxf = REPO_ROOT / "V2/Hardware/Prototype/structure/spool-50mm.dxf"
