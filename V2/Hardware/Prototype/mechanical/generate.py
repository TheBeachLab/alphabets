...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default="prototype",
        help="physical V2 variant; this isolated source generates Prototype only",
    )
    parser.add_argument(
        "--profile",
        type=Path,
    ...
    if variant.id != "prototype":
        parser.error(
            "this source tree is isolated for Prototype; use "
            "V2/Hardware/Final/mechanical for Definitivo"
        )
